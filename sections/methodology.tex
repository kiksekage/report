...
These word embeddings, as used in the model, are trained as specified [MIKOLOV]. The objective of the training is the learn word representations that have a predictive ability to guess the surrounding words. 
